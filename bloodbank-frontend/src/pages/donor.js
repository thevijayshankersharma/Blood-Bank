...
import { FaSearch, FaSort, FaUserAlt, FaTint, FaHospital, FaCalendarAlt, FaDonate } from 'react-icons/fa';
  ...
  return (
    <PageWrapper page="Donor">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h4 className="fw-bold"><FaUserAlt className="me-2" />Donors</h4>
            ...
            <div className="col-md-6">
              ...
              <div className="input-group">
                ...
                >
                  ...
                  <option value="owner">Donor (A-Z)</option>
                  <option value="-owner">Donor (Z-A)</option>
                  <option value="hospital">Hospital (A-Z)</option>
                  <option value="-hospital">Hospital (Z-A)</option>
      ...
      {loading ? (
        <div className="text-center py-5">
          ...
          <p className="mt-3">Loading donor data...</p>
        </div>
      ) : error ? (
        ...
        <div className="alert alert-info" role="alert">
          No donor data found. Try adjusting your search criteria.
        </div>
      ) : (
        <div className="row">
          {donor.map(d => (
                ...
                <div className="card-body">
                  <div className="d-flex align-items-center mb-3">
                    <div 
                      ...
                      style={{
                        backgroundColor: getBloodGroupColor(d?.donor_details?.blood_group),
                        color: 'white',
                        padding: '8px 15px',
                        borderRadius: '50px',
                        fontWeight: 'bold',
                  ...
                  <div className="d-flex align-items-center mb-3">
                    ...
                    <div>
                      ...
                      <h6>{d?.hospital_name || 'Unknown Hospital'}</h6>
                    </div>
                  </div>
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      <p className="mb-0 text-muted">Donation Date</p>
                      <h6>{moment(d?.created_at).fromNow()}</h6>
                    </div>
                  </div>
                </div>
              </div>
